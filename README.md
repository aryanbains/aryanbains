...
currently open to building with **ambitious AI teams** — AI infra · agents · full-stack product engineering · 0→1 systems  
...
13 specialist agents · custom orchestration layer · live browser control · company memory · 50+ integrations · paying customers · rebuilt from scratch twice

**GoverRAJ** — automation for Rajasthan Police.  
promotion pipeline: 6–14 months → 2–4 weeks · 30+ government rules encoded · 8 manual steps automated · confidential government project

**PenguinBot** — conversational AI assistant.  
multi-provider LLM routing · context management · custom personality layer · early project that got me deep into how LLM systems work under the hood
...
<sub>most of the good stuff is in private repos. ask.</sub>
